    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left">
        ...
        <el-form-item label="Question" prop="questionId">
          <el-select v-model="temp.questionId" filterable placeholder="Select question..." remote
            reserve-keyword :remote-method="remoteMethodQuestion" :loading="remoteLoading">
...
<script>
import { fetchList, fetchPv, addUpdateQuestionLike, deleteQuestionLike } from '@/api/questionLike'
  ...
  methods: {
    ...
    createData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          addUpdateQuestionLike(this.temp).then(() => {
    ...
    updateData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          addUpdateQuestionLike(tempData).then(() => {
    ...
    handleDelete(row, index) {
      this.$swal.fire({
        ...
        if (result.isConfirmed) {
          deleteQuestionLike({ _id: row._id }).then(() => {
            this.$notify({
              title: 'Success',
